        ...
        this.data = {
            ...
            barrel_grau556_standard: {
                ...
                locales: {
                    ...
                    "ch": {
                    "Name": "ZLR GRAU 556 标准枪管",
                    "ShortName": "GRAU 556 标准枪管",
                    "Description": "ZLR GRAU 556的标准枪管"
                    }
                }
            },
            ...
            sight_front_grau_hg550: {
                ...
                "_proto": "55d4af3a4bdc2d972f8b456f",
                overrideProperties: {
                    Prefab: {
                        path: "assets/grau/mods/sight_front_grau_hg550.bundle",
                        rcid: ""
    ...
    onLoadMod() {
        ...
        for (let x in this.data) {
            ...
            const item = {
                ...
                _props: this.data[x]._props,
                _type: this.data[x]._type,
                _id: id,
